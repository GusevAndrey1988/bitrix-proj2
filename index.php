<?php
    ...
    $APPLICATION->SetPageProperty("TITLE", "Moschino | Minimalist Free HTML Portfolio by WowThemes.net");
?> 
            ...
            <article class="hentry">
                <header class="entry-header">
                    <div class="entry-thumbnail">
                        <a href="portfolio-item.html"><img src="https://via.placeholder.com/256" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="p1"/></a>
                    </div>
